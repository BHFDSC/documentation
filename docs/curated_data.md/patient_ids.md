...
| **3) One-time-use ID**: IF neither an NHS number or an MPS ID could be assigned. | <img src="https://bhfdsc.github.io/documentation/assets/images/not_linkable.png" alt="linkable" style="width: 900px; height: auto;"> |
