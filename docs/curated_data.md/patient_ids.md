...
| --- | --- |
| **1) NHS number**:  From Personal Demographic Service (PDS) records - the collection of all NHS numbers and patients’ demographic information. | <img src="https://bhfdsc.github.io/documentation/assets/images/linkable_all_tables.png", alt="linkable" style="width:100px; height:auto:"> |
